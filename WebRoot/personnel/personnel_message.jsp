...
<body>
	...
	<form action="servlet/OwnServlet?method=update" method="post">
	<div class="formbody">
		<div class="formtitle">
			<span>基本信息</span>
		</div>
		<ul class="forminfo">
			...
			<li><label>员工姓名:</label> <input name="ename" type="text"
				class="dfinput" value="${emp.ename}"/><i></i></li>
			...
			<li><label>出生日期:</label> <input name="birth" type="text"
				class="dfinput"
				onfocus="WdatePicker({skin:'whyGreen',lang:'zh-cn'})" value="${emp.birth}"/></li>
			<li><label>入职时间:</label> <input name="indate" type="text"
				class="dfinput"
				onfocus="WdatePicker({skin:'whyGreen',lang:'zh-cn'})" value="${emp.indate}"/><i></i></li>

			<li><label>离职时间:</label> <input name="leave" type="text"
				class="dfinput"
				onfocus="WdatePicker({skin:'whyGreen',lang:'zh-cn'})" value="${emp.leave}"/><i></i></li>
			...
			<li><label>联系方式:</label> <input name="phone" type="text"
				class="dfinput" value="${emp.phone}"/></li>
			<li><label>QQ号:</label> <input name="qq" type="text"
				class="dfinput" value="${emp.qq}"/></li>
			<li><label>身份证号:</label> <input name="idcard" type="text"
				class="dfinput" value="${emp.idcard }"/></li>
			<li><label>紧急联系人信息:</label> <textarea name="linkman" cols=""
					rows="" id="ecp" class="textinput">${emp.linkman }</textarea></li>
