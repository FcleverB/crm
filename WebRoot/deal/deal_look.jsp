...
<script type="text/javascript">
	...
	function change(size,index){
		location.href="servlet/BarginServlet?method=toaudit&size="+size+"&index="+index;
	}
</script>
</head>
...
<body>
	<div class="place">
		...
		<ul class="placeul">
			<li><a href="#">交易管理</a></li>
			<li><a href="#">查看交易单</a></li>
		</ul>
	</div>
	<div class="rightinfo">
		<form action="servlet/BarginServlet?method=toaudit" method="post">
			<ul class="prosearch">
			...
			<tbody>
				<c:forEach items="${pageBean.list}" var="bar">
					<tr>
						...
						<td>${bar.remark}</td>
						<td>${bar.status}</td>
						<td><a href="javascript:open('deal/deal_audit.jsp?barid=${bar.barid}','','width=500,height=230,left=500,top=275,location=0,scrollbars=0,resizable=0')" class="tablelink">审核</a></td>
					</tr>
				</c:forEach>
