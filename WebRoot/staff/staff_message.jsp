...
<script type="text/javascript">
	function change(size,index){
		location.href="servlet/HomeServlet?method=findHom&function=2&size="+size+"&index="+index;
	}
</script>
</head>
...
<body>
	...
	<div class="rightinfo">
		<form action="servlet/HomeServlet?method=findHom&function=2" method="post">
		<ul class="prosearch">
