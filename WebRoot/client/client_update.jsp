...
<body>
	...
	<form action="servlet/ClientServlet?method=update" method="post">
		<div class="formbody">
			<div class="formtitle">
				<span>基本信息</span>
			</div>
			<ul class="forminfo">
				<li><label>客户编号:</label> <input name="cliid" type="text"
					class="dfinput" value="${cli.cliid}"/><i></i></li>
				<li><label>客户姓名:</label> <input name="cname" type="text"
					class="dfinput" value="${cli.cname}"/></li>
				...
				<li><label>客户地址:</label>
					<div
						...
						区/县: 
						<select name="town" id="town" style="width: 100px;height: 30px">
							<option value="福建省">福建省</option>
							<option value="山东省">山东省</option>
						</select>
					</div></li>
				<li><label>客户手机:</label> <input name="phone" type="text"
					class="dfinput" value="${cli.phone}"/></li>
				<li><label>QQ:</label> <input name="qq" type="text"
					class="dfinput" value="${cli.qq}"/></li>
				<li><label>邮箱:</label> <input name="email" type="text"
					class="dfinput" value="${cli.email }"/></li>
				<li><label>备注:</label> <textarea name="remark" id="ecp" cols=""
						rows="" class="textinput">${cli.remark}</textarea></li>
